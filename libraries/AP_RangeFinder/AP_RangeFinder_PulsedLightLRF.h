 ...
 *
 *  ------------------------------------------------------------------------------------------
 *  |             J2-1(LED) J2-2(5V) J2-3(Enable) J2-4(Ref Clk) J2-5(GND) J2-6(HV Bypass)    |
 *  |                                                                                        |
 *  |                                                                                        | 
...
// registers
#define AP_RANGEFINDER_PULSEDLIGHTLRF_X01_REG               0x01    
#define AP_RANGEFINDER_PULSEDLIGHTLRF_X02_REG               0x02    
#define AP_RANGEFINDER_PULSEDLIGHTLRF_X04_REG               0x04    
#define AP_RANGEFINDER_PULSEDLIGHTLRF_X12_REG               0x12    
...
// Initialization
#define AP_RANGEFINDER_PULSEDLIGHTLRF_X01REG_INIT           0x30
#define AP_RANGEFINDER_PULSEDLIGHTLRF_X02REG_INIT           0x40
#define AP_RANGEFINDER_PULSEDLIGHTLRF_X04REG_INIT           0x59
#define AP_RANGEFINDER_PULSEDLIGHTLRF_X12REG_INIT           0x30 
